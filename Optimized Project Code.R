...
# make muVec; vector with average fitness in each environment
muVec = numeric(N+1)
...
# make sigma, (n+1)x(n+1) variance-covariance matrix
#sigma = array( data = c(cov(data)), dim = c(dim(data)[1], dim(data)[2]))
#sigma1 = cov.shrink(data) #shrink to positive definite matrix 
